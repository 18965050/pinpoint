package com.navercorp.pinpoint.testapp.startup;
...
/**
 * lvchenggang 2018/1/8
 **/
public class EmbedTomcatTestAppWebServer {

    private static final Logger log = LoggerFactory.getLogger(EmbedTomcatTestAppWebServer.class);

    private static final String CONNECTOR_PORT = "28081";
    ...
    private static String getAbsolutePath() {
        String path = null;
        String folderPath = EmbedTomcatTestAppWebServer.class.getProtectionDomain().getCodeSource().getLocation()
            .getPath();
